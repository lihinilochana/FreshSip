...
return (
        ...
        <div className='col-sm-8 py-2 px-5 offset-2 shadow' id='Body2'>
            ...
            <h2 className="heading" style={{textAlign: 'center'}}>Admin Registration Form</h2><br></br>
        <div>
        ...
        <div className='form-group row mb-2' >
                ...
                <div className='col-sm-8'>
                <select className='form-select' name="userType" value={formData.userType} onChange={handleInputChange} required>
